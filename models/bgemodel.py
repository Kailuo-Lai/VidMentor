...
class BGEModel:
    def __init__(self,args):
        ...
        with new_cd(parent_dir):
            self.tokenizer = AutoTokenizer.from_pretrained(f"../checkpoints/{args.bge_version}")
            self.model = AutoModel.from_pretrained(f"../checkpoints/{args.bge_version}")
        self.query_instruction_for_retrieval = args.query_instruction_for_retrieval
